...
class UseFilterTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.p1 = make_product(
            name="Bracelet rouge", price=30.0, product_type=ProductType.BRACELET
        )
        self.p2 = make_product(
            name="Collier bleu", price=60.0, product_type=ProductType.COLLIER
        )
        self.p3 = make_product(
            name="Sac noir", price=100.0, product_type=ProductType.SAC_DIVERS
        )
    ...
    def test_no_filter_returns_all(self):
        ...
        request = self._request()
        result, form, count, filter_used = use_filter(
            request, self.products, is_all_products=True
        )
    ...
    def test_search_filter(self):
        ...
        result, _, count, filter_used = use_filter(
            request, self.products, is_all_products=True
        )

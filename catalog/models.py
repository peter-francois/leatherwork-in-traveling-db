...
class Product(models.Model):
    ...
    category = models.CharField(max_length=50, choices=Category.choices, verbose_name='Catégorie', default='')
    product_type = models.CharField(max_length=50, choices=ProductType.choices, verbose_name='Type', default='')
    description = models.CharField(max_length=135, blank=True, null=True, verbose_name='Description')
    ...
    pending_in_cart = models.BooleanField(default=False, verbose_name='En attente dans panier')

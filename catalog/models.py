...
class Product(models.Model):
    ...
    description = models.TextField(
        default="", max_length=500, blank=True, verbose_name="Description"
    )
    characteristics = models.TextField(
        blank=True, max_length=500, verbose_name="Caractéristiques"
    )
    ...
    seo_title = models.CharField(
        max_length=70, verbose_name="seo_title", default="", blank=True
    )
    seo_h1 = models.CharField(
        max_length=70, verbose_name="seo_h1", default="", blank=True
    )

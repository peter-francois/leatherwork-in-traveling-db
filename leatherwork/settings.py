"""
Django settings for leatherwork project.
...
# Local apps
LOCAL_APPS = ["core", "legal", "catalog", "cart"]
...
MIDDLEWARE = [
    ...
    "leatherwork.middleware.CustomRequestMiddleware",
]

ROOT_URLCONF = "leatherwork.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "leatherwork.settings.global_variables",
            ],
        },
    },
]

WSGI_APPLICATION = "leatherwork.wsgi.application"
...
if IS_PROD:
    ...
    CSP_IMG_SRC = (
        ...
        "https://www.leatherworkintravelingdb.com",
    )
